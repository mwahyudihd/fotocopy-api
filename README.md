...
- Create: Adding data using Post Method.
- Read / View: view all data or be filtered with Get Method.
- Update: Editing data with Put Method.
- Delete / Remove: to Remove the data using Delete Method.
- Login : Create login tokens by generating random tokens for session data using Get and Post Method.